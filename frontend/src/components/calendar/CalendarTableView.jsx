 ...
 */
// ===== FUNCIONES HELPER (fuera del componente para evitar problemas de hoisting/minificación) =====

// Verificar si un día es festivo para un empleado específico según su ubicación
const isHolidayHelper = (dateString, employeeLocation, holidays) => {
...
const getActivityForDayHelper = (employeeId, dateString, activities) => {
...
const getActivityCodeHelper = (activity) => {
  if (!activity) return ''
...
const getCellBackgroundColorHelper = (activity, isWeekend, isHolidayDay) => {
...
const getCellTextColorHelper = (activity, isWeekend, isHolidayDay) => {
...
const getMonthSummaryHelper = (employeeId, monthDate, activities) => {
...
const getMonthHolidaysHelper = (monthDate, holidays) => {
